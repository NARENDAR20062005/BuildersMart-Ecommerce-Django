...
urlpatterns = [
    ...
    path('download1-invoice/<int:orderID>/<int:productID>', views.download1_invoice_view,name='download1-invoice'),
    path('download-invoice/<int:orderID>/<int:productID>/emailsent/', views.email_sent_view, name='email_sent'),
